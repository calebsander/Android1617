...
public class CantonBeaconAutonomous extends BaseOpMode {
	...
	protected void loopBeforeStart() {
		...
		this.configuration.advanceShooterToDownAutonomous(); //make sure shooter begins in down position, ready to shoot
	}
	...
	protected void loopAfterStart() {
		...
		if (this.stage.ordinal() >= Stage.DRIVE_OFF_WALL.ordinal()) this.configuration.advanceShooterToDownAutonomous();
