package org.gearticks.components.velocity.component.vuforia;
...
public class SelectBeaconSide extends OpModeComponentHardware<VelocityConfiguration, SideOfButton> {
	...
	public static class PictureResult {
		public BeaconColorCounts colorCounts;
	}
}
