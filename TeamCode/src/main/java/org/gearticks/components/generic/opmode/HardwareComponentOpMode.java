package org.gearticks.components.generic.opmode;
 ...
 */
public abstract class HardwareComponentOpMode<HARDWARE_TYPE extends HardwareConfiguration> extends BaseOpMode {
	protected HARDWARE_TYPE configuration;
	private OpModeComponent<?> component;
	 ...
	 */
	protected abstract OpModeComponent<?> getComponent(OpModeContext<HARDWARE_TYPE> opModeContext);
	/**
