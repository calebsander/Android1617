...
//        sm.addComponent(new GiroDriveToRangeDistance(0, -30.0, 0.15, 4000, this.configuration, "Range sensor drive to wall"));
//        sm.addComponent(new GiroTurn(0.0, this.configuration, "Straighten out"));
//        sm.addComponent(new GiroDriveAlongWallEncoder(15, 0.0, 0.25, 10000, this.configuration, "Range sensor drive along wall"));
