...
public class RedSideAutonomous extends LinearStateMachine {
    public RedSideAutonomous(int distanceFromWall, @NonNull GamepadWrapper[] gamepads, Telemetry telemetry, @NonNull VuforiaConfiguration vuforiaConfiguration, @NonNull VelocityConfiguration configuration) {
        ...
        //Drive to wall
        addComponent(new GiroBananaTurnEncoder(0.0, 70.0, 0.3, 2000, configuration, "BTL 20 - 1000"));
        ...
        //Press beacon
        addComponent(new GiroDriveAlongWallLine(distanceFromWall, 0.0, -0.05, 500, configuration, "Adjust to white line"));
        addComponent(new Wait(0.3, "Wait for 0.5 sec"));
        addComponent(new GiroTurn(0.0, configuration, "Straighten out"));
        addComponent(new SidePressBeaconButton(0.0, vuforiaConfiguration, configuration, "Press Button"));

        //Go to second beacon
        addComponent(new GiroDriveAlongWallEncoder(distanceFromWall, 0.0, -0.25, 3000, configuration, "Range sensor drive along wall"));
