...
public class RedSideAutonomous extends LinearStateMachine {
    public RedSideAutonomous(int distanceFromWall, @NonNull GamepadWrapper[] gamepads, Telemetry telemetry, @NonNull VuforiaConfiguration vuforiaConfiguration, @NonNull VelocityConfiguration configuration) {
        ...
        addComponent(new GiroDriveAlongWallLine(distanceFromWall+1, 0.0, 0.4, 6000, configuration, "Range sensor drive along wall"));
        ...
        //Go to second beacon
        addComponent(new GiroDriveAlongWallEncoder(distanceFromWall+1, 0.0, -0.7, 3000, configuration, "Range sensor drive along wall"));
        addComponent(new GiroDriveAlongWallLine(distanceFromWall+1, 0.0, -0.25, 4000, configuration, "Range sensor drive along wall to line"));
        ...
        addComponent(new RaiseSideRollers(configuration, "Disengage rollers"));
        addComponent(new GiroBananaTurnEncoder(0.0, -135.0, 0.7, 3500, configuration, "Banana to face Cap Ball"));
        addComponent(new GiroDriveEncoder(-135.0, 1.0, 5500, configuration, "Hit and park"));
    }
}
