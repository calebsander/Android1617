...
public class RedSideAutonomous extends LinearStateMachine {
    public RedSideAutonomous(int distanceFromWall, OpModeContext<VelocityConfiguration> opModeContext) {
        ...
        addComponent(new GiroDriveAlongWallLine(distanceFromWall, 0.0, 0.4, 6000, opModeContext, "Range sensor drive along wall"));
        ...
        //Go to second beacon
        addComponent(new GiroDriveAlongWallEncoder(distanceFromWall, 0.0, -0.7, 3000, opModeContext, "Range sensor drive along wall"));
        addComponent(new GiroDriveAlongWallLine(distanceFromWall, 0.0, -0.25, 4000, opModeContext, "Range sensor drive along wall to line"));
        ...
        addComponent(new DisengageSideRollers(opModeContext, "Disengage rollers"));
        addComponent(new GiroBananaTurnEncoder(0.0, -135.0, 0.7, 3500, opModeContext, "Banana to face Cap Ball"));
        addComponent(new GiroDriveEncoder(-135.0, 0.7, 5500, opModeContext, "Hit and park"));
    }
}
