...
public class RedSideCornerAutonomous extends LinearStateMachine {
	...
	public RedSideCornerAutonomous(OpModeContext<VelocityConfiguration> opModeContext) {
		...
		//Get to far beacon
		addComponent(new GiroDriveEncoder(315.0, 0.5, 3000, opModeContext, "Drive forward"));
		addComponent(new GiroBananaTurnEncoder(0.0, 0.0, 0.4, 8000, opModeContext, "Banana turn to wall"));
