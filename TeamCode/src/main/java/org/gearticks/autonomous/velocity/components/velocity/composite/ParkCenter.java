...
public class ParkCenter extends NetworkedStateMachine {
	public ParkCenter(int pos, VelocityConfiguration configuration, String id) {
		switch (pos) {
			case 1:
			...
			case 2:
				...
				break;
			default: throw new RuntimeException("Position is not 1 or 2: ParkCenter");
		}
	}
