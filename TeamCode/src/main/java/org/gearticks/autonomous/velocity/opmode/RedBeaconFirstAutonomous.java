...
public class RedBeaconFirstAutonomous extends VelocityBaseOpMode {
    ...
    protected AutonomousComponent getComponent(OpModeContext<VelocityConfiguration> opModeContext) {
        ...
        waitAndDrive.addComponent(new GiroDriveEncoderNoStop(315.0, 0.6, 4000, opModeContext, "Drive forward"));
        waitAndDrive.addComponent(new BananaTurnNoGiro(0.0, 0.6, 6000, opModeContext, "Banana turn to wall"));
        ...
        intakeAndDrive.addComponent(new RunIntake(4.0, true, opModeContext, "Intake particle"));
        ...
        sm.addComponent(new GiroDriveAlongWallLine(DISTANCE_FROM_WALL + 1, 0.0, -0.3, 2000, opModeContext, "Range sensor drive along wall to line"));
