...
extends AutonomousComponentTimer<TRANSITION_TYPE> {
    ...
    public AutonomousComponentHardware(OpModeContext<HARDWARE_TYPE> opModeContext, Class<TRANSITION_TYPE> transitionClass) {
        super(transitionClass);
        this.configuration = opModeContext.configuration;
    }

    public AutonomousComponentHardware(OpModeContext<HARDWARE_TYPE> opModeContext, Class<TRANSITION_TYPE> transitionClass, String id) {
