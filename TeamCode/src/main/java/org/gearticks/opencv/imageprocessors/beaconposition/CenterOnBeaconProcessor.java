...
public class CenterOnBeaconProcessor implements ImageProcessor<BeaconPositionResult> {
    ...
    public ImageProcessorResult<BeaconPositionResult> process(long startTime, Mat rgbaFrame, boolean saveImages) {
        ...
        if (saveImages) {
            ImageUtil.saveImage(TAG, dstBlue, Imgproc.COLOR_RGBA2BGR, "1_blue_inrange", startTime);
            ImageUtil.saveImage(TAG, dstBlue, Imgproc.COLOR_RGBA2BGR, "1_red_inrange", startTime);
        }
        ...
        if (saveImages) {
            ImageUtil.saveImage(TAG, dstBlue, Imgproc.COLOR_RGBA2BGR, "2_blue_morph", startTime);
            ImageUtil.saveImage(TAG, dstBlue, Imgproc.COLOR_RGBA2BGR, "3_red_morph", startTime);
        }
