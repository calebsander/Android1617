...
public enum BeaconColor {
    ...
    RED (new Scalar(160,0,100), new Scalar(180,256,256), new Scalar(0,0,255)),
...
//	RED (new Scalar(170,80,100), new Scalar(180,200,255), new Scalar(0,0,255)),
    UNKNOWN (new Scalar(0,0,0), new Scalar(0,0,0), new Scalar(0,0,0))
    ;
	...
	private BeaconColor(Scalar hsvMin, Scalar hsvMax, Scalar color) {
		this.hsvMin = hsvMin;
		this.hsvMax = hsvMax;
		this.bgrColor = color;
	}
